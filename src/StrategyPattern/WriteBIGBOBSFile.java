 ...
 * class is dedicated to the BIGBOBS shipping method, and overrides the method
 ...
 * happens when a company uses BIGBOBS as it's carrier
 * @author josh
 */
public class WriteBIGBOBSFile implements WriteCarrierFile
{
    /**
     * Implemented from the WriteCarrierFile interface WriteToFile() Method
     * specifically for BIGBOBS carrier
     */
    @Override
    public void WriteToFile()
    {
        System.out.println("Writes a generic csv file for a small local delivery co.");
    }
