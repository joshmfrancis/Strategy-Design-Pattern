 ...
 * class is dedicated to the UPS shipping method, and overrides the method from
 ...
 * happens when a company uses UPS as it's carrier
 * @author josh
 */
public class WriteUPSFile implements WriteCarrierFile
{
    /**
     * Implemented from the WriteCarrierFile interface WriteToFile() Method
     * specifically for UPS carrier
     */
    @Override
    public void WriteToFile()
    {
        System.out.println("Writes a file properly formatted for UPS");
    }
